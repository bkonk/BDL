...
image_sizes = {'cityscapes': (1024,512), 'gta5': (1280, 720), 'synthia': (1280, 760),'triangle':(512,512)}
...
def CreateSrcDataLoader(args): 
    ...
    elif args.source == 'triangle':
        source_dataset = triangleDataset(args.data_dir, args.data_list, max_iters=args.num_steps * args.batch_size,
